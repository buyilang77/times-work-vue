<template>
  <div :class="{fullscreen:fullscreen}" class="tinymce-container" :style="{width:containerWidth}">
    ...
    <div class="editor-custom-btn-container">
      <el-button icon="el-icon-download" :loading="handleImageLoading" size="mini" plain @click="handleImage">
        处理微信图片
      </el-button>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    async handleImage() {
      ...
      const ContentDom = window.tinymce.get(this.tinymceId).getContent()
      const image_regex = /<img [^>]*src=['"]([^'"]+)[^>]*>/g
      const replacedImage = await replaceAsync(ContentDom, image_regex, imageAsyncFn)
      this.setContent(replacedImage)
